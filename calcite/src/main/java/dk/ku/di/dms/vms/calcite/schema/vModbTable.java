...
public class vModbTable extends AbstractTable implements ScannableTable {

    private final String tableName;
    private final List<String> fieldNames;
    private final List<SqlTypeName> fieldTypes;
    private final vModbTableStatistic statistic;

    private RelDataType rowType;

    private vModbTable(String tableName, List<String> fieldNames, List<SqlTypeName> fieldTypes, vModbTableStatistic statistic) {
    ...
    public static final class Builder {
        ...
        public vModbTable build() {
            ...
            return new vModbTable(tableName, fieldNames, fieldTypes, new vModbTableStatistic(rowCount));
        }
    }
}