...
/**
 * Translates a Calcite physical plan (VModb* RelNodes) into a
 * {@link DistributedPlan}: a flat list of remote scan subplans plus a local
 * coordinator operator tree. Extracts WHERE
 * predicates into JSON PredicateDTOs for pushdown. Unsupported predicate
