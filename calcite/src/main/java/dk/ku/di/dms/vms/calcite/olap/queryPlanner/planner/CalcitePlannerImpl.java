...
/** Πarses/validates/converts SQL via {@link Optimizer}, applies
 *  FILTER_INTO_JOIN pushdown with a HepPlanner, then runs Volcano with the VModb*
 *  rules to produce a VMODBconvention physical plan. */
