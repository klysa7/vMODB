    ...
    private void fetchNextBatch() {
        ...
        try {
            ...
            if (type == WORKER_ABORT_TYPE) {
                LOGGER.log(ERROR, "Received WORKER_ABORT (102) from VMS for table: "
            ...
            if (type == END_OF_STREAM_TYPE) {
                ...
                LOGGER.log(INFO, "Clean End of stream reached. Total read: "
                        + recordsRead);
                close();
                return;
            }
            ...
            LOGGER.log(ERROR, "FATAL ERROR during fetchNextBatch!", e);
            close();
        }
    }
