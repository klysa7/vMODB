...
/**
 * Local hash join executed at the gateway when a join is not pushed down as
 * a broadcast. Phase 1 builds a hash table from the left input keyed on
 * {@code leftKeyIndices}; phase 2 probes it with right rows on
 * {@code rightKeyIndices}, emitting concatenated rows in batches of 1000.
 * Rows whose key columns are all zero/empty are dropped as ghost records.
 */
...
//                System.out.println("Buffered " + totalLeftRows + " valid rows... (Dropped " + ghostRecordsDropped + " ghosts)");
            }
        }

        buildTimeMs = System.currentTimeMillis() - start;
//        System.out.println("BUILD COMPLETED!");
//        System.out.println("Valid Left Rows Buffered: " + totalLeftRows);
//        System.out.println(" Time: " + buildTimeMs + " ms");
//        System.out.println("==========================================\n");
//
...
//                        System.out.println("Total Right Rows Scanned: " + totalRightRowsProbed);
//                        System.out.println("Total Matches Found: " + totalMatches);
//                        System.out.println("Probe Time: " + probeTimeMs + " ms");
//                        System.out.println("TOTAL JOIN TIME: " + (buildTimeMs + probeTimeMs) + " ms");
//                        System.out.println("==========================================\n");
                        return null;
                    }
                    break;
...
//                System.out.println("Probed " + totalRightRowsProbed + " rows, found " + totalMatches + " matches...");
            }
        }
