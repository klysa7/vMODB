...
public class vModbSchema extends AbstractSchema {

    private final String schemaName;
    private final Map<String, Table> tableMap;

    private vModbSchema(String schemaName, Map<String, Table> tableMap) {
    ...
    public static final class Builder {
        ...
        public Builder addTable(vModbTable table) {
        ...
        public vModbSchema build() {
            return new vModbSchema(schemaName, tableMap);
        }
    }
}
