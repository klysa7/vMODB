...
/** Builds the Calcite root schema from a {@link CoordinatorCatalog}, mapping catalog
 *  types to SqlTypeName and attaching per-table row-count estimates. Row counts use a
 *  hardcoded TPC-C (num_ware=1) heuristic, defaulting to 1,000,000 for unknown tables*/
...
//                    "table=" + table.tableName() + " rowCount=" + rowCount);
